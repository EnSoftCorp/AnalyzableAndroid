...
static final int TRANSACTION_setForegroundDispatch = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_setAppCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_dispatch = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_setReaderMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_setP2pModes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
}
