...
mRemote.transact(Stub.TRANSACTION_onServerRegistered, _data, _reply, 0);
...
_data.writeString(address);
mRemote.transact(Stub.TRANSACTION_onServerConnectionState, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
mRemote.transact(Stub.TRANSACTION_onServiceAdded, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
mRemote.transact(Stub.TRANSACTION_onCharacteristicReadRequest, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
mRemote.transact(Stub.TRANSACTION_onDescriptorReadRequest, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
mRemote.transact(Stub.TRANSACTION_onCharacteristicWriteRequest, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
_data.writeByteArray(value);
mRemote.transact(Stub.TRANSACTION_onDescriptorWriteRequest, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
