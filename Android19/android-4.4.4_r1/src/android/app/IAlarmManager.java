...
this.set(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5);
...
@Override public void set(int type, long triggerAtTime, long windowLength, long interval, android.app.PendingIntent operation, android.os.WorkSource workSource) throws android.os.RemoteException
{
...
@Override public void setTime(long millis) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void remove(android.app.PendingIntent operation) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/** windowLength == 0 means exact; windowLength < 0 means the let the OS decide */
public void set(int type, long triggerAtTime, long windowLength, long interval, android.app.PendingIntent operation, android.os.WorkSource workSource) throws android.os.RemoteException;
