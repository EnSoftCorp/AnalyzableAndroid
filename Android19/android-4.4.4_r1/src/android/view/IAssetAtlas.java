 ...
 * Original file: frameworks/base/core/java/android/view/IAssetAtlas.aidl
 */
...
/**
     ...
     */
@Override public int[] getMap() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int[] _result;
