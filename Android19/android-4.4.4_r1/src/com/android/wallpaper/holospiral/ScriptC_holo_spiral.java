...
public class ScriptC_holo_spiral extends ScriptC {
    ...
    public Script.FieldID getFieldID_gPVGeometry() {
        return createFieldID(mExportVarIdx_gPVGeometry, null);
    }
    ...
    public Script.FieldID getFieldID_gPFGeometry() {
        return createFieldID(mExportVarIdx_gPFGeometry, null);
    }
    ...
    public Script.FieldID getFieldID_gPSGeometry() {
        return createFieldID(mExportVarIdx_gPSGeometry, null);
    }
    ...
    public Script.FieldID getFieldID_gInnerGeometry() {
        return createFieldID(mExportVarIdx_gInnerGeometry, null);
    }
    ...
    public Script.FieldID getFieldID_gOuterGeometry() {
        return createFieldID(mExportVarIdx_gOuterGeometry, null);
    }
    ...
    public Script.FieldID getFieldID_gPointTexture() {
        return createFieldID(mExportVarIdx_gPointTexture, null);
    }
    ...
    public Script.FieldID getFieldID_gNearPlane() {
        return createFieldID(mExportVarIdx_gNearPlane, null);
    }
    ...
    public Script.FieldID getFieldID_gFarPlane() {
        return createFieldID(mExportVarIdx_gFarPlane, null);
    }
