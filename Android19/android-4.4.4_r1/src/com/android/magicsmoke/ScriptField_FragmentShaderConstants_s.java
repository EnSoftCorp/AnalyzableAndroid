...
public class ScriptField_FragmentShaderConstants_s extends android.renderscript.Script.FieldBase {
    ...
    public static Element createElement(RenderScript rs) {
        ...
        eb.add(Element.F32_4(rs), "clearColor");
        return eb.create();
    }
    ...
    public synchronized void set_clearColor(int index, Float4 v, boolean copyNow) {
        if (mIOBuffer == null) mIOBuffer = new FieldPacker(Item.sizeof * getType().getX()/* count */);
        if (mItemArray == null) mItemArray = new Item[getType().getX() /* count */];
        if (mItemArray[index] == null) mItemArray[index] = new Item();
        mItemArray[index].clearColor = v;
        if (copyNow)  {
            mIOBuffer.reset(index * Item.sizeof);
            mIOBuffer.addF32(v);
    ...
    public synchronized Float4 get_clearColor(int index) {
        if (mItemArray == null) return null;
        return mItemArray[index].clearColor;
    }
