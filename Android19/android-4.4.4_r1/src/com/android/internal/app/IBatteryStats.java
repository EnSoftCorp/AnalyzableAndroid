...
@Override public void noteStartWakelock(int uid, int pid, java.lang.String name, int type) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void noteStopWakelock(int uid, int pid, java.lang.String name, int type) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void noteStartWakelockFromSource(android.os.WorkSource ws, int pid, java.lang.String name, int type) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void noteStopWakelockFromSource(android.os.WorkSource ws, int pid, java.lang.String name, int type) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_noteVibratorOn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_noteVibratorOff = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_noteStartGps = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_noteStopGps = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_noteScreenOn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_noteScreenBrightness = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_noteScreenOff = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_noteInputEvent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_noteUserActivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_notePhoneOn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_notePhoneOff = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_notePhoneSignalStrength = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_notePhoneDataConnectionState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_notePhoneState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_noteWifiOn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_noteWifiOff = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_noteWifiRunning = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_noteWifiRunningChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_noteWifiStopped = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_noteBluetoothOn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_noteBluetoothOff = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_noteFullWifiLockAcquired = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_noteFullWifiLockReleased = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_noteWifiScanStarted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_noteWifiScanStopped = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_noteWifiMulticastEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_noteWifiMulticastDisabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_noteFullWifiLockAcquiredFromSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_noteFullWifiLockReleasedFromSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_noteWifiScanStartedFromSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_noteWifiScanStoppedFromSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_noteWifiBatchedScanStartedFromSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_noteWifiBatchedScanStoppedFromSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_noteWifiMulticastEnabledFromSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_noteWifiMulticastDisabledFromSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_noteNetworkInterfaceType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_noteNetworkStatsEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_setBatteryState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_getAwakeTimeBattery = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_getAwakeTimePlugged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
}
