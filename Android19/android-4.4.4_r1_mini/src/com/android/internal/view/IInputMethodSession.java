...
@Override public void finishInput() throws android.os.RemoteException
{
...
static final int TRANSACTION_appPrivateCommand = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_toggleSoftInput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_finishSession = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
}
