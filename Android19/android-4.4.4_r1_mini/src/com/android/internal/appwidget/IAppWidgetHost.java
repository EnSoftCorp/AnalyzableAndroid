...
int _arg2;
_arg2 = data.readInt();
this.updateAppWidget(_arg0, _arg1, _arg2);
return true;
}
...
int _arg2;
_arg2 = data.readInt();
this.providerChanged(_arg0, _arg1, _arg2);
return true;
}
...
int _arg2;
_arg2 = data.readInt();
this.viewDataChanged(_arg0, _arg1, _arg2);
return true;
}
}
...
@Override public void updateAppWidget(int appWidgetId, android.widget.RemoteViews views, int userId) throws android.os.RemoteException
{
...
@Override public void providerChanged(int appWidgetId, android.appwidget.AppWidgetProviderInfo info, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
@Override public void providersChanged(int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
@Override public void viewDataChanged(int appWidgetId, int viewId, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
public void updateAppWidget(int appWidgetId, android.widget.RemoteViews views, int userId) throws android.os.RemoteException;
public void providerChanged(int appWidgetId, android.appwidget.AppWidgetProviderInfo info, int userId) throws android.os.RemoteException;
public void providersChanged(int userId) throws android.os.RemoteException;
public void viewDataChanged(int appWidgetId, int viewId, int userId) throws android.os.RemoteException;
}
