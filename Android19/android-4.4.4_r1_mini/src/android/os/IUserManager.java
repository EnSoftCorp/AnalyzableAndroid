...
static final int TRANSACTION_isRestricted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_setGuestEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_isGuestEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_wipeUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_getUserSerialNumber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_getUserHandle = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_getUserRestrictions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_setUserRestrictions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_setApplicationRestrictions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_getApplicationRestrictions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_getApplicationRestrictionsForUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_setRestrictionsChallenge = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_checkRestrictionsChallenge = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_hasRestrictionsChallenge = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_removeRestrictions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
}
