...
this.vibratePattern(_arg0, _arg1, _arg2, _arg3, _arg4);
reply.writeNoException();
return true;
}
...
@Override public void vibrate(int uid, java.lang.String packageName, long milliseconds, android.os.IBinder token) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void vibratePattern(int uid, java.lang.String packageName, long[] pattern, int repeat, android.os.IBinder token) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void vibrate(int uid, java.lang.String packageName, long milliseconds, android.os.IBinder token) throws android.os.RemoteException;
public void vibratePattern(int uid, java.lang.String packageName, long[] pattern, int repeat, android.os.IBinder token) throws android.os.RemoteException;
