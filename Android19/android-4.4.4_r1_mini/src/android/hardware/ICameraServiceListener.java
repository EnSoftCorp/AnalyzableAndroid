 ...
 * Original file: frameworks/base/core/java/android/hardware/ICameraServiceListener.aidl
 */
...
/**
     ...
     */
@Override public void onStatusChanged(int status, int cameraId) throws android.os.RemoteException
{
