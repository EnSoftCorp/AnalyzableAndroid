...
@Override public void attach(android.service.wallpaper.IWallpaperConnection connection, android.os.IBinder windowToken, int windowType, boolean isPreview, int reqWidth, int reqHeight) throws android.os.RemoteException
{
