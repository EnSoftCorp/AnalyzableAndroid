 ...
 * Original file: frameworks/base/core/java/android/content/IAnonymousSyncAdapter.aidl
 */
 ...
 * {@hide}
 */
public interface IAnonymousSyncAdapter extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements android.content.IAnonymousSyncAdapter
{
private static final java.lang.String DESCRIPTOR = "android.content.IAnonymousSyncAdapter";
...
/**
 * Cast an IBinder object into an android.content.IAnonymousSyncAdapter interface,
 * generating a proxy if needed.
 */
public static android.content.IAnonymousSyncAdapter asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof android.content.IAnonymousSyncAdapter))) {
return ((android.content.IAnonymousSyncAdapter)iin);
}
return new android.content.IAnonymousSyncAdapter.Stub.Proxy(obj);
}
...
private static class Proxy implements android.content.IAnonymousSyncAdapter
{
