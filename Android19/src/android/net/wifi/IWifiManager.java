...
{
data.enforceInterface(DESCRIPTOR);
this.captivePortalCheckComplete();
reply.writeNoException();
return true;
}
...
@Override public void startScan(android.os.WorkSource ws) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public android.os.Messenger getWifiStateMachineMessenger() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
android.os.Messenger _result;
...
@Override public void captivePortalCheckComplete() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_isScanAlwaysAvailable = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_acquireWifiLock = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_updateWifiLockWorkSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_releaseWifiLock = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_initializeMulticastFiltering = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_isMulticastEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_acquireMulticastLock = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_releaseMulticastLock = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_setWifiApEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_getWifiApEnabledState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_getWifiApConfiguration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_setWifiApConfiguration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_startWifi = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_stopWifi = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_addToBlacklist = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_clearBlacklist = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_getWifiServiceMessenger = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_getWifiStateMachineMessenger = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_getConfigFile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_captivePortalCheckComplete = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_enableTdls = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_enableTdlsWithMacAddress = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_requestBatchedScan = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_stopBatchedScan = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_getBatchedScanResults = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_isBatchedScanSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_pollBatchedScan = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
}
...
public void startScan(android.os.WorkSource ws) throws android.os.RemoteException;
