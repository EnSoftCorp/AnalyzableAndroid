...
int _result = this.synthesizeToFileDescriptor(_arg0, _arg1, _arg2, _arg3);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
...
/**
     ...
     * @param param Request parameters.
     */
@Override public int synthesizeToFileDescriptor(android.os.IBinder callingInstance, java.lang.String text, android.os.ParcelFileDescriptor fileDescriptor, android.os.Bundle params) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
/**
     ...
     * @param param Request parameters.
     */
public int synthesizeToFileDescriptor(android.os.IBinder callingInstance, java.lang.String text, android.os.ParcelFileDescriptor fileDescriptor, android.os.Bundle params) throws android.os.RemoteException;
/**
     * Plays an existing audio resource.
     *
     * @param callingInstance a binder representing the identity of the calling
