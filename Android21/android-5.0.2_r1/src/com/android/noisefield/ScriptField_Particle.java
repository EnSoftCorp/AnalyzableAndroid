...
public class ScriptField_Particle extends android.renderscript.Script.FieldBase {
    ...
    public static Element createElement(RenderScript rs) {
        ...
        eb.add(Element.F32(rs), "speed");
        eb.add(Element.F32(rs), "wander");
        eb.add(Element.F32(rs), "alphaStart");
        eb.add(Element.F32(rs), "alpha");
        eb.add(Element.I32(rs), "life");
        eb.add(Element.I32(rs), "death");
    ...
    public synchronized void set_speed(int index, float v, boolean copyNow) {
        if (mIOBuffer == null) mIOBuffer = new FieldPacker(mElement.getBytesSize() * getType().getX()/* count */);
        if (mItemArray == null) mItemArray = new Item[getType().getX() /* count */];
        if (mItemArray[index] == null) mItemArray[index] = new Item();
        mItemArray[index].speed = v;
        if (copyNow)  {
    ...
    public synchronized void set_wander(int index, float v, boolean copyNow) {
        if (mIOBuffer == null) mIOBuffer = new FieldPacker(mElement.getBytesSize() * getType().getX()/* count */);
        if (mItemArray == null) mItemArray = new Item[getType().getX() /* count */];
        if (mItemArray[index] == null) mItemArray[index] = new Item();
        mItemArray[index].wander = v;
        if (copyNow)  {
    ...
    public synchronized void set_alphaStart(int index, float v, boolean copyNow) {
        if (mIOBuffer == null) mIOBuffer = new FieldPacker(mElement.getBytesSize() * getType().getX()/* count */);
        if (mItemArray == null) mItemArray = new Item[getType().getX() /* count */];
        if (mItemArray[index] == null) mItemArray[index] = new Item();
        mItemArray[index].alphaStart = v;
        if (copyNow)  {
    ...
    public synchronized void set_alpha(int index, float v, boolean copyNow) {
        if (mIOBuffer == null) mIOBuffer = new FieldPacker(mElement.getBytesSize() * getType().getX()/* count */);
        if (mItemArray == null) mItemArray = new Item[getType().getX() /* count */];
        if (mItemArray[index] == null) mItemArray[index] = new Item();
        mItemArray[index].alpha = v;
        if (copyNow)  {
    ...
    public synchronized void set_life(int index, int v, boolean copyNow) {
        if (mIOBuffer == null) mIOBuffer = new FieldPacker(mElement.getBytesSize() * getType().getX()/* count */);
        if (mItemArray == null) mItemArray = new Item[getType().getX() /* count */];
        if (mItemArray[index] == null) mItemArray[index] = new Item();
        mItemArray[index].life = v;
        if (copyNow)  {
    ...
    public synchronized void set_death(int index, int v, boolean copyNow) {
        if (mIOBuffer == null) mIOBuffer = new FieldPacker(mElement.getBytesSize() * getType().getX()/* count */);
        if (mItemArray == null) mItemArray = new Item[getType().getX() /* count */];
        if (mItemArray[index] == null) mItemArray[index] = new Item();
        mItemArray[index].death = v;
        if (copyNow)  {
    ...
    public synchronized float get_speed(int index) {
        if (mItemArray == null) return 0;
        return mItemArray[index].speed;
    }

    public synchronized float get_wander(int index) {
        if (mItemArray == null) return 0;
        return mItemArray[index].wander;
    }

    public synchronized float get_alphaStart(int index) {
        if (mItemArray == null) return 0;
        return mItemArray[index].alphaStart;
    }

    public synchronized float get_alpha(int index) {
        if (mItemArray == null) return 0;
        return mItemArray[index].alpha;
    }

    public synchronized int get_life(int index) {
        if (mItemArray == null) return 0;
        return mItemArray[index].life;
    }

    public synchronized int get_death(int index) {
        if (mItemArray == null) return 0;
        return mItemArray[index].death;
    }
