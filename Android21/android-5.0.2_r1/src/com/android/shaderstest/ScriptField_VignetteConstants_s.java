 ...
 * @hide
 */
public class ScriptField_VignetteConstants_s extends android.renderscript.Script.FieldBase {
    ...
    public static Element createElement(RenderScript rs) {
        ...
        eb.add(Element.F32(rs), "feather");
        eb.add(Element.F32(rs), "width");
        eb.add(Element.F32(rs), "height");
        return eb.create();
    }

    private  ScriptField_VignetteConstants_s(RenderScript rs) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    }

    public  ScriptField_VignetteConstants_s(RenderScript rs, int count) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
        init(rs, count);
    ...
    public  ScriptField_VignetteConstants_s(RenderScript rs, int count, int usages) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    ...
    public static ScriptField_VignetteConstants_s create1D(RenderScript rs, int dimX, int usages) {
        ScriptField_VignetteConstants_s obj = new ScriptField_VignetteConstants_s(rs);
        obj.mAllocation = Allocation.createSized(rs, obj.mElement, dimX, usages);
        return obj;
    }

    public static ScriptField_VignetteConstants_s create1D(RenderScript rs, int dimX) {
        return create1D(rs, dimX, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_VignetteConstants_s create2D(RenderScript rs, int dimX, int dimY) {
        return create2D(rs, dimX, dimY, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_VignetteConstants_s create2D(RenderScript rs, int dimX, int dimY, int usages) {
        ScriptField_VignetteConstants_s obj = new ScriptField_VignetteConstants_s(rs);
    ...
    public static ScriptField_VignetteConstants_s createCustom(RenderScript rs, Type.Builder tb, int usages) {
        ScriptField_VignetteConstants_s obj = new ScriptField_VignetteConstants_s(rs);
        Type t = tb.create();
    ...
    public synchronized void set_feather(int index, float v, boolean copyNow) {
        if (mIOBuffer == null) mIOBuffer = new FieldPacker(mElement.getBytesSize() * getType().getX()/* count */);
        if (mItemArray == null) mItemArray = new Item[getType().getX() /* count */];
        if (mItemArray[index] == null) mItemArray[index] = new Item();
        mItemArray[index].feather = v;
        if (copyNow)  {
    ...
    public synchronized void set_width(int index, float v, boolean copyNow) {
        if (mIOBuffer == null) mIOBuffer = new FieldPacker(mElement.getBytesSize() * getType().getX()/* count */);
        if (mItemArray == null) mItemArray = new Item[getType().getX() /* count */];
        if (mItemArray[index] == null) mItemArray[index] = new Item();
    ...
    public synchronized void set_height(int index, float v, boolean copyNow) {
        if (mIOBuffer == null) mIOBuffer = new FieldPacker(mElement.getBytesSize() * getType().getX()/* count */);
        if (mItemArray == null) mItemArray = new Item[getType().getX() /* count */];
        if (mItemArray[index] == null) mItemArray[index] = new Item();
    ...
    public synchronized float get_feather(int index) {
        if (mItemArray == null) return 0;
        return mItemArray[index].feather;
    }

    public synchronized float get_width(int index) {
        if (mItemArray == null) return 0;
        return mItemArray[index].width;
    }

    public synchronized float get_height(int index) {
        if (mItemArray == null) return 0;
