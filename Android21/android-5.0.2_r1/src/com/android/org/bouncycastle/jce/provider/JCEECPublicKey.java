...
// import com.android.org.bouncycastle.asn1.cryptopro.CryptoProObjectIdentifiers;
// import com.android.org.bouncycastle.asn1.cryptopro.ECGOST3410NamedCurves;
// import com.android.org.bouncycastle.asn1.cryptopro.GOST3410PublicKeyAlgParameters;
// END android-removed
...
// BEGIN android-removed
// import com.android.org.bouncycastle.jce.ECGOST3410NamedCurveTable;
// END android-removed
    ...
    implements ECPublicKey, com.android.org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder
{
    ...
    public com.android.org.bouncycastle.math.ec.ECPoint getQ()
    {
        if (ecSpec == null)
        {
            if (q instanceof com.android.org.bouncycastle.math.ec.ECPoint.Fp)
            {
                return new com.android.org.bouncycastle.math.ec.ECPoint.Fp(null, q.getAffineXCoord(), q.getAffineYCoord());
            }
            else
            {
                return new com.android.org.bouncycastle.math.ec.ECPoint.F2m(null, q.getAffineXCoord(), q.getAffineYCoord());
            }
        }
