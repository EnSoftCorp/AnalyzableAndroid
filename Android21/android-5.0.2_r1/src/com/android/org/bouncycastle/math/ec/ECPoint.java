...
//            ECFieldElement.F2m.checkFieldElements(a.x, b.x);
        ...
        /* (non-Javadoc)
         * @see com.android.org.bouncycastle.math.ec.ECPoint#add(com.android.org.bouncycastle.math.ec.ECPoint)
         */
        public ECPoint add(ECPoint b)
        {
            checkPoints(this, b);
        ...
        /* (non-Javadoc)
         * @see com.android.org.bouncycastle.math.ec.ECPoint#subtract(com.android.org.bouncycastle.math.ec.ECPoint)
         */
        public ECPoint subtract(ECPoint b)
        {
            checkPoints(this, b);
