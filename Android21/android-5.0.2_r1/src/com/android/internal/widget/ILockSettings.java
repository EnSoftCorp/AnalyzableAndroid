...
{
data.enforceInterface(DESCRIPTOR);
com.android.internal.widget.ILockSettingsObserver _arg0;
_arg0 = com.android.internal.widget.ILockSettingsObserver.Stub.asInterface(data.readStrongBinder());
...
@Override public void registerObserver(com.android.internal.widget.ILockSettingsObserver observer) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void unregisterObserver(com.android.internal.widget.ILockSettingsObserver observer) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_registerObserver = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_unregisterObserver = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
}
...
public void registerObserver(com.android.internal.widget.ILockSettingsObserver observer) throws android.os.RemoteException;
public void unregisterObserver(com.android.internal.widget.ILockSettingsObserver observer) throws android.os.RemoteException;
}
