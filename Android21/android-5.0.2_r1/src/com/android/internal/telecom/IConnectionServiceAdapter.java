...
case TRANSACTION_setCallCapabilities:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
int _arg1;
_arg1 = data.readInt();
this.setCallCapabilities(_arg0, _arg1);
return true;
}
...
@Override public void setCallCapabilities(java.lang.String callId, int callCapabilities) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
mRemote.transact(Stub.TRANSACTION_setCallCapabilities, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_setCallCapabilities = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
...
static final int TRANSACTION_queryRemoteConnectionServices = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_setVideoProvider = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_setVideoState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_setIsVoipAudioMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_setStatusHints = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_setAddress = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_setCallerDisplayName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_setConferenceableConnections = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
}
...
public void setCallCapabilities(java.lang.String callId, int callCapabilities) throws android.os.RemoteException;
