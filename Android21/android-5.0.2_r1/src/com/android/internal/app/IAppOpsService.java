...
static final int TRANSACTION_checkAudioOperation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_setAudioRestriction = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_setUserRestrictions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_removeUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
}
// These first methods are also called by native code, so must
// be kept in sync with frameworks/native/include/binder/IAppOpsService.h
