...
@Override public void listenForSubscriber(long subId, java.lang.String pkg, com.android.internal.telephony.IPhoneStateListener callback, int events, boolean notifyNow) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void notifyCallStateForSubscriber(long subId, int state, java.lang.String incomingNumber) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void notifyServiceStateForPhoneId(int phoneId, long subId, android.telephony.ServiceState state) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void notifySignalStrengthForSubscriber(long subId, android.telephony.SignalStrength signalStrength) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void notifyMessageWaitingChangedForPhoneId(int phoneId, long subId, boolean mwi) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void notifyCallForwardingChangedForSubscriber(long subId, boolean cfi) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void notifyDataActivityForSubscriber(long subId, int state) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void notifyDataConnectionFailedForSubscriber(long subId, java.lang.String reason, java.lang.String apnType) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void notifyCellLocationForSubscriber(long subId, android.os.Bundle cellLocation) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void notifyCellInfoForSubscriber(long subId, java.util.List<android.telephony.CellInfo> cellInfo) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void notifyOemHookRawEventForSubscriber(long subId, byte[] rawData) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_listenForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_notifyCallState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_notifyCallStateForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_notifyServiceStateForPhoneId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_notifySignalStrength = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_notifySignalStrengthForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_notifyMessageWaitingChangedForPhoneId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_notifyCallForwardingChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_notifyCallForwardingChangedForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_notifyDataActivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_notifyDataActivityForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_notifyDataConnection = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_notifyDataConnectionForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_notifyDataConnectionFailed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_notifyDataConnectionFailedForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_notifyCellLocation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_notifyCellLocationForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_notifyOtaspChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_notifyCellInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_notifyPreciseCallState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_notifyDisconnectCause = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_notifyPreciseDataConnectionFailed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_notifyCellInfoForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_notifyDataConnectionRealTimeInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_notifyVoLteServiceStateChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_notifyOemHookRawEventForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
}
...
public void listenForSubscriber(long subId, java.lang.String pkg, com.android.internal.telephony.IPhoneStateListener callback, int events, boolean notifyNow) throws android.os.RemoteException;
public void notifyCallState(int state, java.lang.String incomingNumber) throws android.os.RemoteException;
public void notifyCallStateForSubscriber(long subId, int state, java.lang.String incomingNumber) throws android.os.RemoteException;
public void notifyServiceStateForPhoneId(int phoneId, long subId, android.telephony.ServiceState state) throws android.os.RemoteException;
public void notifySignalStrength(android.telephony.SignalStrength signalStrength) throws android.os.RemoteException;
public void notifySignalStrengthForSubscriber(long subId, android.telephony.SignalStrength signalStrength) throws android.os.RemoteException;
public void notifyMessageWaitingChangedForPhoneId(int phoneId, long subId, boolean mwi) throws android.os.RemoteException;
public void notifyCallForwardingChanged(boolean cfi) throws android.os.RemoteException;
public void notifyCallForwardingChangedForSubscriber(long subId, boolean cfi) throws android.os.RemoteException;
public void notifyDataActivity(int state) throws android.os.RemoteException;
public void notifyDataActivityForSubscriber(long subId, int state) throws android.os.RemoteException;
...
public void notifyDataConnectionFailedForSubscriber(long subId, java.lang.String reason, java.lang.String apnType) throws android.os.RemoteException;
public void notifyCellLocation(android.os.Bundle cellLocation) throws android.os.RemoteException;
public void notifyCellLocationForSubscriber(long subId, android.os.Bundle cellLocation) throws android.os.RemoteException;
...
public void notifyCellInfoForSubscriber(long subId, java.util.List<android.telephony.CellInfo> cellInfo) throws android.os.RemoteException;
...
public void notifyOemHookRawEventForSubscriber(long subId, byte[] rawData) throws android.os.RemoteException;
}
