...
case TRANSACTION_getDeviceIdForSubscriber:
{
data.enforceInterface(DESCRIPTOR);
long _arg0;
_arg0 = data.readLong();
java.lang.String _result = this.getDeviceIdForSubscriber(_arg0);
reply.writeNoException();
reply.writeString(_result);
return true;
}
...
/**
     ...
     * for GSM phones.
     */
@Override public java.lang.String getDeviceIdForSubscriber(long subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
mRemote.transact(Stub.TRANSACTION_getDeviceIdForSubscriber, _data, _reply, 0);
_reply.readException();
_result = _reply.readString();
}
finally {
...
/**
     * Retrieves the IMEI.
     */
@Override public java.lang.String getImeiForSubscriber(long subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
/**
     ...
     */
@Override public java.lang.String getSubscriberIdForSubscriber(long subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
/**
     ...
     */
@Override public java.lang.String getGroupIdLevel1ForSubscriber(long subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
/**
     ...
     */
@Override public java.lang.String getIccSerialNumberForSubscriber(long subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
/**
     ...
     */
@Override public java.lang.String getLine1NumberForSubscriber(long subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
/**
     ...
     */
@Override public java.lang.String getLine1AlphaTagForSubscriber(long subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
/**
     ...
     */
@Override public java.lang.String getMsisdnForSubscriber(long subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
/**
     ...
     */
@Override public java.lang.String getVoiceMailNumberForSubscriber(long subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
/**
     ...
     */
@Override public java.lang.String getCompleteVoiceMailNumberForSubscriber(long subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
/**
     ...
     * of a subId.
     */
@Override public java.lang.String getVoiceMailAlphaTagForSubscriber(long subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
/**
     ...
     */
@Override public java.lang.String getIccSimChallengeResponse(long subId, int appType, java.lang.String data) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
static final int TRANSACTION_getDeviceIdForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_getImeiForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_getDeviceSvn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_getSubscriberId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_getSubscriberIdForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_getGroupIdLevel1 = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_getGroupIdLevel1ForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_getIccSerialNumber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_getIccSerialNumberForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_getLine1Number = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_getLine1NumberForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_getLine1AlphaTag = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_getLine1AlphaTagForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_getMsisdn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_getMsisdnForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_getVoiceMailNumber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_getVoiceMailNumberForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_getCompleteVoiceMailNumber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_getCompleteVoiceMailNumberForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_getVoiceMailAlphaTag = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_getVoiceMailAlphaTagForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_getIsimImpi = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_getIsimDomain = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_getIsimImpu = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_getIsimIst = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_getIsimPcscf = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_getIsimChallengeResponse = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_getIccSimChallengeResponse = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
}
/**
     * Retrieves the unique device ID, e.g., IMEI for GSM phones.
     */
...
/**
     ...
     * for GSM phones.
     */
public java.lang.String getDeviceIdForSubscriber(long subId) throws android.os.RemoteException;
/**
     * Retrieves the IMEI.
     */
public java.lang.String getImeiForSubscriber(long subId) throws android.os.RemoteException;
/**
     * Retrieves the software version number for the device, e.g., IMEI/SV
     * for GSM phones.
     */
...
/**
     * Retrieves the unique subscriber ID of a given subId, e.g., IMSI for GSM phones.
     */
public java.lang.String getSubscriberIdForSubscriber(long subId) throws android.os.RemoteException;
/**
     * Retrieves the Group Identifier Level1 for GSM phones.
     */
...
/**
     * Retrieves the Group Identifier Level1 for GSM phones of a subId.
     */
public java.lang.String getGroupIdLevel1ForSubscriber(long subId) throws android.os.RemoteException;
/**
     * Retrieves the serial number of the ICC, if applicable.
     */
...
/**
     * Retrieves the serial number of a given subId.
     */
public java.lang.String getIccSerialNumberForSubscriber(long subId) throws android.os.RemoteException;
/**
     * Retrieves the phone number string for line 1.
     */
...
/**
     * Retrieves the phone number string for line 1 of a subcription.
     */
public java.lang.String getLine1NumberForSubscriber(long subId) throws android.os.RemoteException;
/**
     * Retrieves the alpha identifier for line 1.
     */
...
/**
     * Retrieves the alpha identifier for line 1 of a subId.
     */
public java.lang.String getLine1AlphaTagForSubscriber(long subId) throws android.os.RemoteException;
/**
     * Retrieves MSISDN Number.
     */
...
/**
     * Retrieves the Msisdn of a subId.
     */
public java.lang.String getMsisdnForSubscriber(long subId) throws android.os.RemoteException;
/**
     * Retrieves the voice mail number.
     */
...
/**
     * Retrieves the voice mail number of a given subId.
     */
public java.lang.String getVoiceMailNumberForSubscriber(long subId) throws android.os.RemoteException;
/**
     * Retrieves the complete voice mail number.
     */
...
/**
     * Retrieves the complete voice mail number for particular subId
     */
public java.lang.String getCompleteVoiceMailNumberForSubscriber(long subId) throws android.os.RemoteException;
/**
     * Retrieves the alpha identifier associated with the voice mail number.
     */
...
/**
     ...
     * of a subId.
     */
public java.lang.String getVoiceMailAlphaTagForSubscriber(long subId) throws android.os.RemoteException;
/**
     * Returns the IMS private user identity (IMPI) that was loaded from the ISIM.
     * @return the IMPI, or null if not present or not loaded
     */
...
/**
     ...
     * @return challenge response
     */
public java.lang.String getIccSimChallengeResponse(long subId, int appType, java.lang.String data) throws android.os.RemoteException;
}
