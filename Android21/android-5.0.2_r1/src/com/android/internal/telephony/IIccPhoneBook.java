...
/**
     ...
     * @return List of AdnRecord
     */
@Override public java.util.List<com.android.internal.telephony.uicc.AdnRecord> getAdnRecordsInEfForSubscriber(long subId, int efid) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.util.List<com.android.internal.telephony.uicc.AdnRecord> _result;
...
/**
     ...
     * @return true for success
     */
@Override public boolean updateAdnRecordsInEfBySearchForSubscriber(long subId, int efid, java.lang.String oldTag, java.lang.String oldPhoneNumber, java.lang.String newTag, java.lang.String newPhoneNumber, java.lang.String pin2) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
/**
     ...
     * @return true for success
     */
@Override public boolean updateAdnRecordsInEfByIndexForSubscriber(long subId, int efid, java.lang.String newTag, java.lang.String newPhoneNumber, int index, java.lang.String pin2) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
/**
     ...
     *            recordSizes[2]  is the number of records in the EF file
     */
@Override public int[] getAdnRecordsSizeForSubscriber(long subId, int efid) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int[] _result;
...
/**
     ...
     * @return List of AdnRecord
     */
public java.util.List<com.android.internal.telephony.uicc.AdnRecord> getAdnRecordsInEfForSubscriber(long subId, int efid) throws android.os.RemoteException;
/**
     * Replace oldAdn with newAdn in ADN-like record in EF
     *
     * getAdnRecordsInEf must be called at least once before this function,
...
/**
     ...
     * @return true for success
     */
public boolean updateAdnRecordsInEfBySearchForSubscriber(long subId, int efid, java.lang.String oldTag, java.lang.String oldPhoneNumber, java.lang.String newTag, java.lang.String newPhoneNumber, java.lang.String pin2) throws android.os.RemoteException;
/**
     * Update an ADN-like EF record by record index
     *
     * This is useful for iteration the whole ADN file, such as write the whole
...
/**
     ...
     * @return true for success
     */
public boolean updateAdnRecordsInEfByIndexForSubscriber(long subId, int efid, java.lang.String newTag, java.lang.String newPhoneNumber, int index, java.lang.String pin2) throws android.os.RemoteException;
/**
     * Get the max munber of records in efid
     *
     * @param efid the EF id of a ADN-like SIM
...
/**
     ...
     *            recordSizes[2]  is the number of records in the EF file
     */
public int[] getAdnRecordsSizeForSubscriber(long subId, int efid) throws android.os.RemoteException;
}
