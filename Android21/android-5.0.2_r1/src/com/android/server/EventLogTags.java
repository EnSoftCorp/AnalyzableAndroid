...
public class EventLogTags {
  ...
  public static void writeNotificationEnqueue(int uid, int pid, String pkg, int id, String tag, int userid, String notification) {
    android.util.EventLog.writeEvent(NOTIFICATION_ENQUEUE, uid, pid, pkg, id, tag, userid, notification);
  }
  ...
  public static void writeNotificationPanelRevealed() {
    android.util.EventLog.writeEvent(NOTIFICATION_PANEL_REVEALED);
  }
  ...
  public static void writeNotificationExpansion(String key, int userAction, int expanded) {
    android.util.EventLog.writeEvent(NOTIFICATION_EXPANSION, key, userAction, expanded);
  }

  public static void writeNotificationClicked(String key) {
    android.util.EventLog.writeEvent(NOTIFICATION_CLICKED, key);
  }
