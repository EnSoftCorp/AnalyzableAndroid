 ...
 * The source Renderscript file: frameworks/rs/java/tests/RSTest_CompatLib/src/com/android/rs/test/atomic.rs
 */
...
public class ScriptC_atomic extends ScriptC {
    ...
    public  ScriptC_atomic(RenderScript rs, Resources resources, int id) {
