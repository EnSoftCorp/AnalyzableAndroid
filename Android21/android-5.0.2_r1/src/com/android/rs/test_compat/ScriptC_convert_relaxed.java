 ...
 * The source Renderscript file: frameworks/rs/java/tests/RSTest_CompatLib/src/com/android/rs/test/convert_relaxed.rs
 */
...
public class ScriptC_convert_relaxed extends ScriptC {
    ...
    public  ScriptC_convert_relaxed(RenderScript rs, Resources resources, int id) {
