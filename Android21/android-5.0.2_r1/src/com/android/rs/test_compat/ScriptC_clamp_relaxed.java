 ...
 * The source Renderscript file: frameworks/rs/java/tests/RSTest_CompatLib/src/com/android/rs/test/clamp_relaxed.rs
 */
...
public class ScriptC_clamp_relaxed extends ScriptC {
    ...
    public  ScriptC_clamp_relaxed(RenderScript rs, Resources resources, int id) {
