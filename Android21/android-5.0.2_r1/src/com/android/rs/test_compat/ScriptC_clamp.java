 ...
 * The source Renderscript file: frameworks/rs/java/tests/RSTest_CompatLib/src/com/android/rs/test/clamp.rs
 */
...
public class ScriptC_clamp extends ScriptC {
    ...
    public  ScriptC_clamp(RenderScript rs, Resources resources, int id) {
