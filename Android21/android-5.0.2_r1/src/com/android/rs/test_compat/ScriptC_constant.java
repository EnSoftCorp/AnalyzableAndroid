 ...
 * The source Renderscript file: frameworks/rs/java/tests/RSTest_CompatLib/src/com/android/rs/test/constant.rs
 */
...
public class ScriptC_constant extends ScriptC {
    ...
    public  ScriptC_constant(RenderScript rs, Resources resources, int id) {
