 ...
 * The source Renderscript file: frameworks/rs/java/tests/RSTest_CompatLib/src/com/android/rs/test/min.rs
 */
...
public class ScriptC_min extends ScriptC {
    ...
    public  ScriptC_min(RenderScript rs, Resources resources, int id) {
