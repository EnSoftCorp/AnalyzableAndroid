 ...
 * The source Renderscript file: frameworks/rs/java/tests/RSTest_CompatLib/src/com/android/rs/test/convert.rs
 */
...
public class ScriptC_convert extends ScriptC {
    ...
    public  ScriptC_convert(RenderScript rs, Resources resources, int id) {
