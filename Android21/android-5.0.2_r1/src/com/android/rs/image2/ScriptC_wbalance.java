 ...
 * The source Renderscript file: frameworks/rs/java/tests/ImageProcessing2/src/com/android/rs/image/wbalance.rs
 */
...
public class ScriptC_wbalance extends ScriptC {
    ...
    public  ScriptC_wbalance(RenderScript rs, Resources resources, int id) {
    ...
    public Script.KernelID getKernelID_whiteBalanceKernel() {
        return createKernelID(mExportForEachIdx_whiteBalanceKernel, 3, null, null);
    }
