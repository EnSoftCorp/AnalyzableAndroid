 ...
 * The source Renderscript file: frameworks/rs/java/tests/ImageProcessing2/src/com/android/rs/image/greyscale.fs
 */
...
public class ScriptC_greyscale extends ScriptC {
    ...
    public  ScriptC_greyscale(RenderScript rs, Resources resources, int id) {
