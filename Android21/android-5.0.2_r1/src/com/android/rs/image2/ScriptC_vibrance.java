 ...
 * The source Renderscript file: frameworks/rs/java/tests/ImageProcessing2/src/com/android/rs/image/vibrance.rs
 */
...
public class ScriptC_vibrance extends ScriptC {
    ...
    public  ScriptC_vibrance(RenderScript rs, Resources resources, int id) {
    ...
    public Script.KernelID getKernelID_vibranceKernel() {
        return createKernelID(mExportForEachIdx_vibranceKernel, 3, null, null);
    }
