 ...
 * The source Renderscript file: frameworks/rs/java/tests/ImageProcessing2/src/com/android/rs/image/colorcube.rs
 */
...
public class ScriptC_colorcube extends ScriptC {
    ...
    public  ScriptC_colorcube(RenderScript rs, Resources resources, int id) {
    ...
    public void invoke_setCube(Allocation c) {
        FieldPacker setCube_fp = new FieldPacker(4);
        setCube_fp.addObj(c);
