 ...
 * The source Renderscript file: frameworks/rs/java/tests/ImageProcessing2/src/com/android/rs/image/levels_relaxed.fs
 */
...
public class ScriptC_levels_relaxed extends ScriptC {
    ...
    public  ScriptC_levels_relaxed(RenderScript rs, Resources resources, int id) {
    ...
    public Script.KernelID getKernelID_root4() {
        return createKernelID(mExportForEachIdx_root4, 59, null, null);
    }
