 ...
 * The source Renderscript file: frameworks/rs/java/tests/ImageProcessing2/src/com/android/rs/image/fisheye_relaxed.fs
 */
...
public class ScriptC_fisheye_relaxed extends ScriptC {
    ...
    public  ScriptC_fisheye_relaxed(RenderScript rs, Resources resources, int id) {
