 ...
 * The source Renderscript file: frameworks/rs/java/tests/ImageProcessing2/src/com/android/rs/image/fisheye_full.rs
 */
...
public class ScriptC_fisheye_full extends ScriptC {
    ...
    public  ScriptC_fisheye_full(RenderScript rs, Resources resources, int id) {
