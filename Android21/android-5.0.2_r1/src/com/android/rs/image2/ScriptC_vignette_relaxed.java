 ...
 * The source Renderscript file: frameworks/rs/java/tests/ImageProcessing2/src/com/android/rs/image/vignette_relaxed.fs
 */
...
public class ScriptC_vignette_relaxed extends ScriptC {
    ...
    public  ScriptC_vignette_relaxed(RenderScript rs, Resources resources, int id) {
