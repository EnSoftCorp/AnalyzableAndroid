 ...
 * The source Renderscript file: frameworks/rs/java/tests/ImageProcessing2/src/com/android/rs/image/colormatrix.fs
 */
...
public class ScriptC_colormatrix extends ScriptC {
    ...
    public  ScriptC_colormatrix(RenderScript rs, Resources resources, int id) {
