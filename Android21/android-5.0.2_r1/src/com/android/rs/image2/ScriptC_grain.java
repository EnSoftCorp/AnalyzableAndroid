 ...
 * The source Renderscript file: frameworks/rs/java/tests/ImageProcessing2/src/com/android/rs/image/grain.fs
 */
...
public class ScriptC_grain extends ScriptC {
    ...
    public  ScriptC_grain(RenderScript rs, Resources resources, int id) {
