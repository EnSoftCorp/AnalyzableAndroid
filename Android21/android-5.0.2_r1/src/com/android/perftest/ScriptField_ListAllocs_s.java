...
public class ScriptField_ListAllocs_s extends android.renderscript.Script.FieldBase {
    ...
    public static Element createElement(RenderScript rs) {
        ...
        eb.add(Element.ALLOCATION(rs), "item");
        return eb.create();
    }
    ...
    public synchronized void set_item(int index, Allocation v, boolean copyNow) {
        if (mIOBuffer == null) mIOBuffer = new FieldPacker(mElement.getBytesSize() * getType().getX()/* count */);
        if (mItemArray == null) mItemArray = new Item[getType().getX() /* count */];
        if (mItemArray[index] == null) mItemArray[index] = new Item();
        mItemArray[index].item = v;
        if (copyNow)  {
            mIOBuffer.reset(index * mElement.getBytesSize());
            mIOBuffer.addObj(v);
    ...
    public synchronized Allocation get_item(int index) {
        if (mItemArray == null) return null;
        return mItemArray[index].item;
    }
