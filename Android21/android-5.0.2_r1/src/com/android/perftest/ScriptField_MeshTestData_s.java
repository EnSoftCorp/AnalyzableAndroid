 ...
 * @hide
 */
public class ScriptField_MeshTestData_s extends android.renderscript.Script.FieldBase {
    ...
    public static Element createElement(RenderScript rs) {
        ...
        eb.add(Element.I32(rs), "meshNum");
        return eb.create();
    }

    private  ScriptField_MeshTestData_s(RenderScript rs) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    }

    public  ScriptField_MeshTestData_s(RenderScript rs, int count) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
        init(rs, count);
    ...
    public  ScriptField_MeshTestData_s(RenderScript rs, int count, int usages) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    ...
    public static ScriptField_MeshTestData_s create1D(RenderScript rs, int dimX, int usages) {
        ScriptField_MeshTestData_s obj = new ScriptField_MeshTestData_s(rs);
        obj.mAllocation = Allocation.createSized(rs, obj.mElement, dimX, usages);
        return obj;
    }

    public static ScriptField_MeshTestData_s create1D(RenderScript rs, int dimX) {
        return create1D(rs, dimX, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_MeshTestData_s create2D(RenderScript rs, int dimX, int dimY) {
        return create2D(rs, dimX, dimY, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_MeshTestData_s create2D(RenderScript rs, int dimX, int dimY, int usages) {
        ScriptField_MeshTestData_s obj = new ScriptField_MeshTestData_s(rs);
    ...
    public static ScriptField_MeshTestData_s createCustom(RenderScript rs, Type.Builder tb, int usages) {
        ScriptField_MeshTestData_s obj = new ScriptField_MeshTestData_s(rs);
        Type t = tb.create();
    ...
    public synchronized void set_meshNum(int index, int v, boolean copyNow) {
        if (mIOBuffer == null) mIOBuffer = new FieldPacker(mElement.getBytesSize() * getType().getX()/* count */);
        if (mItemArray == null) mItemArray = new Item[getType().getX() /* count */];
        if (mItemArray[index] == null) mItemArray[index] = new Item();
        mItemArray[index].meshNum = v;
        if (copyNow)  {
            mIOBuffer.reset(index * mElement.getBytesSize());
            mIOBuffer.addI32(v);
    ...
    public synchronized int get_meshNum(int index) {
        if (mItemArray == null) return 0;
        return mItemArray[index].meshNum;
    }
