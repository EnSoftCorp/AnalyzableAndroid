...
public class ScriptC_fbosync extends ScriptC {
    private static final String __rs_resource_name = "fbosync";
    // Constructor
    public  ScriptC_fbosync(RenderScript rs) {
        this(rs,
    ...
    public synchronized void set_gReadBackTest(Allocation v) {
    ...
    public Script.FieldID getFieldID_gReadBackTest() {
        return createFieldID(mExportVarIdx_gReadBackTest, null);
    }
