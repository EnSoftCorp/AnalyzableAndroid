...
static final int TRANSACTION_getProperty = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
...
static final int TRANSACTION_setListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_setMute = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_start = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_startConference = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_accept = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_reject = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_terminate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_hold = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_resume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_merge = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_update = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_extendToConference = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_inviteParticipants = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_removeParticipants = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_sendDtmf = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_sendUssd = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_getVideoCallProvider = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
}
/**
     * Closes the object. This object is not usable after being closed.
     */
