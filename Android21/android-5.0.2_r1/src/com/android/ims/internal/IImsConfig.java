 ...
 * Original file: frameworks/base/telephony/java/com/android/ims/internal/IImsConfig.aidl
 */
...
case TRANSACTION_getMasterValue:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
int _result = this.getMasterValue(_arg0);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
case TRANSACTION_getMasterStringValue:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
java.lang.String _result = this.getMasterStringValue(_arg0);
reply.writeNoException();
...
int _arg1;
_arg1 = data.readInt();
this.setProvisionedValue(_arg0, _arg1);
reply.writeNoException();
return true;
}
...
this.setProvisionedStringValue(_arg0, _arg1);
reply.writeNoException();
return true;
}
...
/**
     ...
     */
@Override public int getMasterValue(int item) throws android.os.RemoteException
{
...
_data.writeInt(item);
mRemote.transact(Stub.TRANSACTION_getMasterValue, _data, _reply, 0);
...
/**
     ...
     */
@Override public java.lang.String getMasterStringValue(int item) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(item);
mRemote.transact(Stub.TRANSACTION_getMasterStringValue, _data, _reply, 0);
_reply.readException();
...
/**
     ...
     * @return void.
     */
@Override public void setProvisionedValue(int item, int value) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
     ...
     * @return void.
     */
@Override public void setProvisionedStringValue(int item, java.lang.String value) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_getMasterValue = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_getMasterStringValue = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
...
/**
     ...
     * @return value in Integer format.
     */
public int getMasterValue(int item) throws android.os.RemoteException;
/**
     * Gets the value for ims service/capabilities parameters from the master
     * value storage. Synchronous blocking call.
     *
     ...
     * @return value in String format.
     */
public java.lang.String getMasterStringValue(int item) throws android.os.RemoteException;
/**
     * Sets the value for IMS service/capabilities parameters by the operator device
     * management entity. It sets the config item value in the provisioned storage
     * from which the master value is derived. Synchronous blocking call.
     ...
     * @return void.
     */
public void setProvisionedValue(int item, int value) throws android.os.RemoteException;
/**
     * Sets the value for IMS service/capabilities parameters by the operator device
     * management entity. It sets the config item value in the provisioned storage
     * from which the master value is derived.  Synchronous blocking call.
     ...
     * @return void.
     */
public void setProvisionedStringValue(int item, java.lang.String value) throws android.os.RemoteException;
/**
     * Gets the value of the specified IMS feature item for specified network type.
     * This operation gets the feature config value from the master storage (i.e. final
     * value). Asynchronous non-blocking call.
