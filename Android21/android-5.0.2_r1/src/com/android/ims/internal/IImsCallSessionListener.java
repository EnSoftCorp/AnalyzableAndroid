 ...
 * Original file: frameworks/base/telephony/java/com/android/ims/internal/IImsCallSessionListener.aidl
 */
...
case TRANSACTION_callSessionMerged:
{
data.enforceInterface(DESCRIPTOR);
com.android.ims.internal.IImsCallSession _arg0;
_arg0 = com.android.ims.internal.IImsCallSession.Stub.asInterface(data.readStrongBinder());
...
this.callSessionMerged(_arg0, _arg1, _arg2);
reply.writeNoException();
return true;
}
...
/**
     ...
     */
@Override public void callSessionMerged(com.android.ims.internal.IImsCallSession session, com.android.ims.internal.IImsCallSession newSession, com.android.ims.ImsCallProfile profile) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_callSessionMerged, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_callSessionMerged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_callSessionMergeFailed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_callSessionUpdated = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_callSessionUpdateFailed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_callSessionUpdateReceived = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_callSessionConferenceExtended = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_callSessionConferenceExtendFailed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_callSessionConferenceExtendReceived = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_callSessionInviteParticipantsRequestDelivered = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_callSessionInviteParticipantsRequestFailed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_callSessionRemoveParticipantsRequestDelivered = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_callSessionRemoveParticipantsRequestFailed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_callSessionConferenceStateUpdated = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_callSessionUssdMessageReceived = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_callSessionHandover = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_callSessionHandoverFailed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
}
/**
     * Notifies the result of the basic session operation (setup / terminate).
     */
...
/**
     * Notifiies the result of call merge operation.
     */
public void callSessionMerged(com.android.ims.internal.IImsCallSession session, com.android.ims.internal.IImsCallSession newSession, com.android.ims.ImsCallProfile profile) throws android.os.RemoteException;
