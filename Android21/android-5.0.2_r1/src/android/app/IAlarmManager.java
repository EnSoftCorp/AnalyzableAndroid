...
if ((0!=data.readInt())) {
_arg6 = android.app.AlarmManager.AlarmClockInfo.CREATOR.createFromParcel(data);
}
else {
_arg6 = null;
}
this.set(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6);
...
@Override public void set(int type, long triggerAtTime, long windowLength, long interval, android.app.PendingIntent operation, android.os.WorkSource workSource, android.app.AlarmManager.AlarmClockInfo alarmClock) throws android.os.RemoteException
{
...
static final int TRANSACTION_getNextAlarmClock = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
}
/** windowLength == 0 means exact; windowLength < 0 means the let the OS decide */
