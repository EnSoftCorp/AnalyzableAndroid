...
static final int TRANSACTION_getZenModeConfig = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_setZenModeConfig = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_notifyConditions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_requestZenModeConditions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_setZenModeCondition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_setAutomaticZenModeConditions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_getAutomaticZenModeConditions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
}
