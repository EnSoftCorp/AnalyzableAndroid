...
case TRANSACTION_launchAssistAction:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
...
int _arg2;
_arg2 = data.readInt();
boolean _result = this.launchAssistAction(_arg0, _arg1, _arg2);
reply.writeNoException();
...
@Override public android.content.ComponentName getAssistIntent(int userHandle) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
android.content.ComponentName _result;
...
@Override public boolean launchAssistAction(int requestType, java.lang.String hint, int userHandle) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
_data.writeInt(userHandle);
mRemote.transact(Stub.TRANSACTION_launchAssistAction, _data, _reply, 0);
_reply.readException();
...
static final int TRANSACTION_getAssistIntent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_launchAssistAction = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
}
...
public android.content.ComponentName getAssistIntent(int userHandle) throws android.os.RemoteException;
public boolean launchAssistAction(int requestType, java.lang.String hint, int userHandle) throws android.os.RemoteException;
}
