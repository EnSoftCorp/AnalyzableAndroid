...
int _arg3;
_arg3 = data.readInt();
this.setTrustAgentFeaturesEnabled(_arg0, _arg1, _arg2, _arg3);
reply.writeNoException();
return true;
}
case TRANSACTION_getTrustAgentFeaturesEnabled:
{
data.enforceInterface(DESCRIPTOR);
android.content.ComponentName _arg0;
if ((0!=data.readInt())) {
...
int _arg2;
_arg2 = data.readInt();
java.util.List<java.lang.String> _result = this.getTrustAgentFeaturesEnabled(_arg0, _arg1, _arg2);
reply.writeNoException();
...
@Override public void setTrustAgentFeaturesEnabled(android.content.ComponentName admin, android.content.ComponentName agent, java.util.List<java.lang.String> features, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeInt(userId);
mRemote.transact(Stub.TRANSACTION_setTrustAgentFeaturesEnabled, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public java.util.List<java.lang.String> getTrustAgentFeaturesEnabled(android.content.ComponentName admin, android.content.ComponentName agent, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
_data.writeInt(userId);
mRemote.transact(Stub.TRANSACTION_getTrustAgentFeaturesEnabled, _data, _reply, 0);
_reply.readException();
...
static final int TRANSACTION_setRecommendedGlobalProxy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_setStorageEncryption = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_getStorageEncryption = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_getStorageEncryptionStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_setCameraDisabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_getCameraDisabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_setScreenCaptureDisabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_getScreenCaptureDisabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_setKeyguardDisabledFeatures = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_getKeyguardDisabledFeatures = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_setActiveAdmin = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_isAdminActive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_getActiveAdmins = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_packageHasActiveAdmins = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_getRemoveWarning = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_removeActiveAdmin = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
static final int TRANSACTION_hasGrantedPolicy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_setActivePasswordState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_reportFailedPasswordAttempt = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
static final int TRANSACTION_reportSuccessfulPasswordAttempt = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
static final int TRANSACTION_setDeviceOwner = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
static final int TRANSACTION_isDeviceOwner = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
static final int TRANSACTION_getDeviceOwner = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
static final int TRANSACTION_getDeviceOwnerName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 55);
static final int TRANSACTION_clearDeviceOwner = (android.os.IBinder.FIRST_CALL_TRANSACTION + 56);
static final int TRANSACTION_setProfileOwner = (android.os.IBinder.FIRST_CALL_TRANSACTION + 57);
static final int TRANSACTION_getProfileOwner = (android.os.IBinder.FIRST_CALL_TRANSACTION + 58);
static final int TRANSACTION_getProfileOwnerName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 59);
static final int TRANSACTION_setProfileEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 60);
static final int TRANSACTION_setProfileName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 61);
static final int TRANSACTION_clearProfileOwner = (android.os.IBinder.FIRST_CALL_TRANSACTION + 62);
static final int TRANSACTION_hasUserSetupCompleted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 63);
static final int TRANSACTION_installCaCert = (android.os.IBinder.FIRST_CALL_TRANSACTION + 64);
static final int TRANSACTION_uninstallCaCert = (android.os.IBinder.FIRST_CALL_TRANSACTION + 65);
static final int TRANSACTION_enforceCanManageCaCerts = (android.os.IBinder.FIRST_CALL_TRANSACTION + 66);
static final int TRANSACTION_installKeyPair = (android.os.IBinder.FIRST_CALL_TRANSACTION + 67);
static final int TRANSACTION_addPersistentPreferredActivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 68);
static final int TRANSACTION_clearPackagePersistentPreferredActivities = (android.os.IBinder.FIRST_CALL_TRANSACTION + 69);
static final int TRANSACTION_setApplicationRestrictions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 70);
static final int TRANSACTION_getApplicationRestrictions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 71);
static final int TRANSACTION_setRestrictionsProvider = (android.os.IBinder.FIRST_CALL_TRANSACTION + 72);
static final int TRANSACTION_getRestrictionsProvider = (android.os.IBinder.FIRST_CALL_TRANSACTION + 73);
static final int TRANSACTION_setUserRestriction = (android.os.IBinder.FIRST_CALL_TRANSACTION + 74);
...
static final int TRANSACTION_setPermittedAccessibilityServices = (android.os.IBinder.FIRST_CALL_TRANSACTION + 77);
static final int TRANSACTION_getPermittedAccessibilityServices = (android.os.IBinder.FIRST_CALL_TRANSACTION + 78);
static final int TRANSACTION_getPermittedAccessibilityServicesForUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 79);
static final int TRANSACTION_setPermittedInputMethods = (android.os.IBinder.FIRST_CALL_TRANSACTION + 80);
static final int TRANSACTION_getPermittedInputMethods = (android.os.IBinder.FIRST_CALL_TRANSACTION + 81);
static final int TRANSACTION_getPermittedInputMethodsForCurrentUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 82);
static final int TRANSACTION_setApplicationHidden = (android.os.IBinder.FIRST_CALL_TRANSACTION + 83);
static final int TRANSACTION_isApplicationHidden = (android.os.IBinder.FIRST_CALL_TRANSACTION + 84);
static final int TRANSACTION_createUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 85);
static final int TRANSACTION_createAndInitializeUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 86);
static final int TRANSACTION_removeUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 87);
static final int TRANSACTION_switchUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 88);
static final int TRANSACTION_enableSystemApp = (android.os.IBinder.FIRST_CALL_TRANSACTION + 89);
static final int TRANSACTION_enableSystemAppWithIntent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 90);
static final int TRANSACTION_setAccountManagementDisabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 91);
static final int TRANSACTION_getAccountTypesWithManagementDisabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 92);
static final int TRANSACTION_getAccountTypesWithManagementDisabledAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 93);
static final int TRANSACTION_setLockTaskPackages = (android.os.IBinder.FIRST_CALL_TRANSACTION + 94);
static final int TRANSACTION_getLockTaskPackages = (android.os.IBinder.FIRST_CALL_TRANSACTION + 95);
static final int TRANSACTION_isLockTaskPermitted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 96);
static final int TRANSACTION_setGlobalSetting = (android.os.IBinder.FIRST_CALL_TRANSACTION + 97);
static final int TRANSACTION_setSecureSetting = (android.os.IBinder.FIRST_CALL_TRANSACTION + 98);
static final int TRANSACTION_setMasterVolumeMuted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 99);
static final int TRANSACTION_isMasterVolumeMuted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 100);
static final int TRANSACTION_notifyLockTaskModeChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 101);
static final int TRANSACTION_setUninstallBlocked = (android.os.IBinder.FIRST_CALL_TRANSACTION + 102);
static final int TRANSACTION_isUninstallBlocked = (android.os.IBinder.FIRST_CALL_TRANSACTION + 103);
static final int TRANSACTION_setCrossProfileCallerIdDisabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 104);
static final int TRANSACTION_getCrossProfileCallerIdDisabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 105);
static final int TRANSACTION_getCrossProfileCallerIdDisabledForUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 106);
static final int TRANSACTION_setTrustAgentFeaturesEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 107);
static final int TRANSACTION_getTrustAgentFeaturesEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 108);
static final int TRANSACTION_addCrossProfileWidgetProvider = (android.os.IBinder.FIRST_CALL_TRANSACTION + 109);
static final int TRANSACTION_removeCrossProfileWidgetProvider = (android.os.IBinder.FIRST_CALL_TRANSACTION + 110);
static final int TRANSACTION_getCrossProfileWidgetProviders = (android.os.IBinder.FIRST_CALL_TRANSACTION + 111);
static final int TRANSACTION_setAutoTimeRequired = (android.os.IBinder.FIRST_CALL_TRANSACTION + 112);
static final int TRANSACTION_getAutoTimeRequired = (android.os.IBinder.FIRST_CALL_TRANSACTION + 113);
}
...
public void setTrustAgentFeaturesEnabled(android.content.ComponentName admin, android.content.ComponentName agent, java.util.List<java.lang.String> features, int userId) throws android.os.RemoteException;
public java.util.List<java.lang.String> getTrustAgentFeaturesEnabled(android.content.ComponentName admin, android.content.ComponentName agent, int userId) throws android.os.RemoteException;
