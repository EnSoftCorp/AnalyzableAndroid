 ...
 * Original file: frameworks/base/core/java/android/service/trust/ITrustAgentServiceCallback.aidl
 */
...
case TRANSACTION_onSetTrustAgentFeaturesEnabledCompleted:
{
data.enforceInterface(DESCRIPTOR);
boolean _arg0;
_arg0 = (0!=data.readInt());
...
this.onSetTrustAgentFeaturesEnabledCompleted(_arg0, _arg1);
return true;
}
}
...
@Override public void onSetTrustAgentFeaturesEnabledCompleted(boolean result, android.os.IBinder token) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
mRemote.transact(Stub.TRANSACTION_onSetTrustAgentFeaturesEnabledCompleted, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_onSetTrustAgentFeaturesEnabledCompleted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
}
...
public void onSetTrustAgentFeaturesEnabledCompleted(boolean result, android.os.IBinder token) throws android.os.RemoteException;
}
