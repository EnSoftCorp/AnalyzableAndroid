...
this.computeClickPointInScreen(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6);
return true;
}
}
...
@Override public void computeClickPointInScreen(long accessibilityNodeId, android.graphics.Region bounds, int interactionId, android.view.accessibility.IAccessibilityInteractionConnectionCallback callback, int interrogatingPid, long interrogatingTid, android.view.MagnificationSpec spec) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
mRemote.transact(Stub.TRANSACTION_computeClickPointInScreen, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_computeClickPointInScreen = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
}
