...
case TRANSACTION_setComputeClickPointInScreenActionResult:
{
data.enforceInterface(DESCRIPTOR);
...
int _arg1;
_arg1 = data.readInt();
this.setComputeClickPointInScreenActionResult(_arg0, _arg1);
return true;
}
}
...
/**
     ...
     * @param interactionId The interaction id to match the result with the request.
     */
@Override public void setComputeClickPointInScreenActionResult(android.graphics.Point point, int interactionId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
_data.writeInt(interactionId);
mRemote.transact(Stub.TRANSACTION_setComputeClickPointInScreenActionResult, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_setComputeClickPointInScreenActionResult = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
}
/**
     * Sets the result of an async request that returns an {@link AccessibilityNodeInfo}.
     *
...
/**
     ...
     * @param interactionId The interaction id to match the result with the request.
     */
public void setComputeClickPointInScreenActionResult(android.graphics.Point point, int interactionId) throws android.os.RemoteException;
}
