...
static final int TRANSACTION_sendVendorCommand = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_addVendorCommandListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_sendStandby = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_setHdmiRecordListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_startOneTouchRecord = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_stopOneTouchRecord = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_startTimerRecording = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_clearTimerRecording = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_sendMhlVendorCommand = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_addHdmiMhlVendorCommandListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
}
