 ...
 * Original file: frameworks/base/core/java/android/hardware/hdmi/IHdmiRecordListener.aidl
 */
...
int _arg0;
_arg0 = data.readInt();
this.onOneTouchRecordResult(_arg0);
reply.writeNoException();
return true;
}
...
int _arg0;
_arg0 = data.readInt();
this.onTimerRecordingResult(_arg0);
reply.writeNoException();
return true;
}
...
int _arg0;
_arg0 = data.readInt();
this.onClearTimerRecordingResult(_arg0);
reply.writeNoException();
return true;
}
}
...
/**
      ...
      */
@Override public void onOneTouchRecordResult(int result) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
      ...
      */
@Override public void onTimerRecordingResult(int result) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
      ...
      */
@Override public void onClearTimerRecordingResult(int result) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
      ...
      * @param result result code for one touch record
      */
public void onOneTouchRecordResult(int result) throws android.os.RemoteException;
/**
      * Called when timer recording is started or failed during initialization.

      * @param result result code for timer recording
      */
public void onTimerRecordingResult(int result) throws android.os.RemoteException;
/**
      * Called when receiving result for clear timer recording request.
      *
      * @param result result of clear timer.
      */
public void onClearTimerRecordingResult(int result) throws android.os.RemoteException;
}
