...
int _arg3;
_arg3 = data.readInt();
this.uninstall(_arg0, _arg1, _arg2, _arg3);
reply.writeNoException();
return true;
}
...
@Override public void uninstall(java.lang.String packageName, int flags, android.content.IntentSender statusReceiver, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void uninstall(java.lang.String packageName, int flags, android.content.IntentSender statusReceiver, int userId) throws android.os.RemoteException;
