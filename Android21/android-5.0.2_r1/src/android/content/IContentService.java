...
@Override public void syncAsUser(android.content.SyncRequest request, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_setMasterSyncAutomatically = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_setMasterSyncAutomaticallyAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_getMasterSyncAutomatically = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_getMasterSyncAutomaticallyAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_getCurrentSyncs = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_getCurrentSyncsAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_getSyncAdapterTypes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_getSyncAdapterTypesAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_isSyncActive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_getSyncStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_getSyncStatusAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_isSyncPending = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_isSyncPendingAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_addStatusChangeListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_removeStatusChangeListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
}
...
public void syncAsUser(android.content.SyncRequest request, int userId) throws android.os.RemoteException;
