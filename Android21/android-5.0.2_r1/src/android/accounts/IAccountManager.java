...
int _arg2;
_arg2 = data.readInt();
this.removeAccountAsUser(_arg0, _arg1, _arg2);
reply.writeNoException();
return true;
}
...
@Override public void removeAccountAsUser(android.accounts.IAccountManagerResponse response, android.accounts.Account account, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_getAuthTokenLabel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_addSharedAccountAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_getSharedAccountsAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_removeSharedAccountAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_renameAccount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_getPreviousName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_renameSharedAccountAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
}
...
public void removeAccountAsUser(android.accounts.IAccountManagerResponse response, android.accounts.Account account, int userId) throws android.os.RemoteException;
