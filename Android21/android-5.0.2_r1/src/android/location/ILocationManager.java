...
android.location.IGpsMeasurementsListener _arg0;
_arg0 = android.location.IGpsMeasurementsListener.Stub.asInterface(data.readStrongBinder());
boolean _result = this.removeGpsMeasurementsListener(_arg0);
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
android.location.IGpsNavigationMessageListener _arg0;
_arg0 = android.location.IGpsNavigationMessageListener.Stub.asInterface(data.readStrongBinder());
boolean _result = this.removeGpsNavigationMessageListener(_arg0);
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
@Override public boolean removeGpsMeasurementsListener(android.location.IGpsMeasurementsListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public boolean removeGpsNavigationMessageListener(android.location.IGpsNavigationMessageListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
public boolean removeGpsMeasurementsListener(android.location.IGpsMeasurementsListener listener) throws android.os.RemoteException;
...
public boolean removeGpsNavigationMessageListener(android.location.IGpsNavigationMessageListener listener) throws android.os.RemoteException;
// --- deprecated ---
