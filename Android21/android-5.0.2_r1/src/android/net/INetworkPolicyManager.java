...
case TRANSACTION_getPowerSaveAppIdWhitelist:
{
data.enforceInterface(DESCRIPTOR);
int[] _result = this.getPowerSaveAppIdWhitelist();
reply.writeNoException();
reply.writeIntArray(_result);
return true;
}
...
@Override public int[] getPowerSaveAppIdWhitelist() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int[] _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getPowerSaveAppIdWhitelist, _data, _reply, 0);
_reply.readException();
_result = _reply.createIntArray();
}
finally {
...
@Override public android.net.NetworkPolicy[] getNetworkPolicies() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public boolean isNetworkMetered(android.net.NetworkState state) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
static final int TRANSACTION_getPowerSaveAppIdWhitelist = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
...
static final int TRANSACTION_setNetworkPolicies = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_getNetworkPolicies = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_snoozeLimit = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_setRestrictBackground = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_getRestrictBackground = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_getNetworkQuotaInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_isNetworkMetered = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
}
/** Control UID policies. */
