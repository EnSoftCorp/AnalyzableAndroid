...
static final int TRANSACTION_getScanResults = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_disconnect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_reconnect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_reassociate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_getConnectionInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_setWifiEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_getWifiEnabledState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_setCountryCode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_setFrequencyBand = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_getFrequencyBand = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_isDualBandSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_saveConfiguration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_getDhcpInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_isScanAlwaysAvailable = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_acquireWifiLock = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_updateWifiLockWorkSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_releaseWifiLock = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_initializeMulticastFiltering = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_isMulticastEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_acquireMulticastLock = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_releaseMulticastLock = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_setWifiApEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_getWifiApEnabledState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_getWifiApConfiguration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_setWifiApConfiguration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_startWifi = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_stopWifi = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_addToBlacklist = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_clearBlacklist = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_getWifiServiceMessenger = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_getConfigFile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_enableTdls = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_enableTdlsWithMacAddress = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_requestBatchedScan = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_stopBatchedScan = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_getBatchedScanResults = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_isBatchedScanSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
static final int TRANSACTION_pollBatchedScan = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_getWpsNfcConfigurationToken = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_enableVerboseLogging = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
static final int TRANSACTION_getVerboseLoggingLevel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
static final int TRANSACTION_getAggressiveHandover = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
static final int TRANSACTION_enableAggressiveHandover = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
static final int TRANSACTION_getAllowScansWithTraffic = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
static final int TRANSACTION_setAllowScansWithTraffic = (android.os.IBinder.FIRST_CALL_TRANSACTION + 55);
static final int TRANSACTION_getConnectionStatistics = (android.os.IBinder.FIRST_CALL_TRANSACTION + 56);
}
