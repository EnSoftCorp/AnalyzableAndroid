...
static final int TRANSACTION_isConnected = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
...
static final int TRANSACTION_isOffloadedFilteringSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_isOffloadedScanBatchingSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
static final int TRANSACTION_isActivityAndEnergyReportingSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_getActivityEnergyInfoFromController = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_reportActivityInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
}
