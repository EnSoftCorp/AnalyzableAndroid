 ...
 * Original file: external/chromium_org/android_webview/../content/public/android/java/src/org/chromium/content/common/IChildProcessCallback.aidl
 */
...
int _arg1;
_arg1 = data.readInt();
org.chromium.content.common.SurfaceWrapper _result = this.getSurfaceTextureSurface(_arg0, _arg1);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
@Override public org.chromium.content.common.SurfaceWrapper getSurfaceTextureSurface(int primaryId, int secondaryId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
org.chromium.content.common.SurfaceWrapper _result;
...
static final int TRANSACTION_getSurfaceTextureSurface = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
}
// Conduit to pass a Surface from the sandboxed renderer to the plugin.
...
public org.chromium.content.common.SurfaceWrapper getSurfaceTextureSurface(int primaryId, int secondaryId) throws android.os.RemoteException;
}
