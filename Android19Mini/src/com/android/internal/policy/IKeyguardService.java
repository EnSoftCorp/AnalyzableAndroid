...
case TRANSACTION_isShowingAndNotHidden:
{
data.enforceInterface(DESCRIPTOR);
boolean _result = this.isShowingAndNotHidden();
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
case TRANSACTION_setHidden:
{
data.enforceInterface(DESCRIPTOR);
boolean _arg0;
_arg0 = (0!=data.readInt());
this.setHidden(_arg0);
return true;
}
...
@Override public boolean isShowingAndNotHidden() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isShowingAndNotHidden, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
@Override public void setHidden(boolean isHidden) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(((isHidden)?(1):(0)));
mRemote.transact(Stub.TRANSACTION_setHidden, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_isShowingAndNotHidden = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
...
static final int TRANSACTION_setHidden = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
...
public void setHidden(boolean isHidden) throws android.os.RemoteException;
