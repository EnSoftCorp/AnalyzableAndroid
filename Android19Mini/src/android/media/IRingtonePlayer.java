...
@Override public void play(android.os.IBinder token, android.net.Uri uri, int streamType) throws android.os.RemoteException
{
...
@Override public void playAsync(android.net.Uri uri, android.os.UserHandle user, boolean looping, int streamType) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/** Used for Notification sound playback. */
public void playAsync(android.net.Uri uri, android.os.UserHandle user, boolean looping, int streamType) throws android.os.RemoteException;
