...
case TRANSACTION_clearAccessibilityNodeInfoCache:
{
data.enforceInterface(DESCRIPTOR);
this.clearAccessibilityNodeInfoCache();
return true;
}
...
@Override public void setConnection(android.accessibilityservice.IAccessibilityServiceConnection connection, int connectionId) throws android.os.RemoteException
{
...
@Override public void clearAccessibilityNodeInfoCache() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_clearAccessibilityNodeInfoCache, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_clearAccessibilityNodeInfoCache = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
