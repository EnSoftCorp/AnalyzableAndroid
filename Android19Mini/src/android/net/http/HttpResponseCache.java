...
public final class HttpResponseCache extends ResponseCache implements Closeable {
    ...
    private HttpResponseCache(com.squareup.okhttp.HttpResponseCache delegate) {
    ...
    public static HttpResponseCache getInstalled() {
        ...
        if (installed instanceof com.squareup.okhttp.HttpResponseCache) {
            return new HttpResponseCache(
                    (com.squareup.okhttp.HttpResponseCache) installed);
        }
    ...
    public static HttpResponseCache install(File directory, long maxSize) throws IOException {
        ResponseCache installed = ResponseCache.getDefault();
        if (installed instanceof com.squareup.okhttp.HttpResponseCache) {
            com.squareup.okhttp.HttpResponseCache installedCache =
                    (com.squareup.okhttp.HttpResponseCache) installed;
        ...
        com.squareup.okhttp.HttpResponseCache responseCache =
                new com.squareup.okhttp.HttpResponseCache(directory, maxSize);
