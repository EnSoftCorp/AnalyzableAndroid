...
int _arg8;
_arg8 = data.readInt();
this.addAppToken(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7, _arg8);
reply.writeNoException();
return true;
}
...
case TRANSACTION_getWindowFrame:
{
data.enforceInterface(DESCRIPTOR);
android.os.IBinder _arg0;
_arg0 = data.readStrongBinder();
...
this.getWindowFrame(_arg0, _arg1);
reply.writeNoException();
if ((_arg1!=null)) {
reply.writeInt(1);
_arg1.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
case TRANSACTION_setMagnificationCallbacks:
{
data.enforceInterface(DESCRIPTOR);
android.view.IMagnificationCallbacks _arg0;
_arg0 = android.view.IMagnificationCallbacks.Stub.asInterface(data.readStrongBinder());
this.setMagnificationCallbacks(_arg0);
reply.writeNoException();
return true;
}
case TRANSACTION_setMagnificationSpec:
{
data.enforceInterface(DESCRIPTOR);
android.view.MagnificationSpec _arg0;
if ((0!=data.readInt())) {
_arg0 = android.view.MagnificationSpec.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
this.setMagnificationSpec(_arg0);
reply.writeNoException();
return true;
}
case TRANSACTION_getCompatibleMagnificationSpecForWindow:
{
data.enforceInterface(DESCRIPTOR);
android.os.IBinder _arg0;
_arg0 = data.readStrongBinder();
android.view.MagnificationSpec _result = this.getCompatibleMagnificationSpecForWindow(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
case TRANSACTION_setTouchExplorationEnabled:
{
data.enforceInterface(DESCRIPTOR);
boolean _arg0;
_arg0 = (0!=data.readInt());
this.setTouchExplorationEnabled(_arg0);
reply.writeNoException();
return true;
}
}
...
@Override public android.view.IWindowSession openSession(com.android.internal.view.IInputMethodClient client, com.android.internal.view.IInputContext inputContext) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public void addAppToken(int addPos, android.view.IApplicationToken token, int groupId, int stackId, int requestedOrientation, boolean fullscreen, boolean showWhenLocked, int userId, int configChanges) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
     ...
     */
@Override public boolean waitForWindowDrawn(android.os.IBinder token, android.os.IRemoteCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
/**
     ...
     */
@Override public android.os.IBinder getFocusedWindowToken() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
/**
     ...
     */
@Override public void setInputFilter(android.view.IInputFilter filter) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
     ...
     */
@Override public void getWindowFrame(android.os.IBinder token, android.graphics.Rect outFrame) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeStrongBinder(token);
mRemote.transact(Stub.TRANSACTION_getWindowFrame, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
...
/**
     ...
     */
@Override public void setMagnificationCallbacks(android.view.IMagnificationCallbacks callbacks) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_setMagnificationCallbacks, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
/**
     ...
     */
@Override public void setMagnificationSpec(android.view.MagnificationSpec spec) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_setMagnificationSpec, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
/**
     ...
     */
@Override public android.view.MagnificationSpec getCompatibleMagnificationSpecForWindow(android.os.IBinder windowToken) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
mRemote.transact(Stub.TRANSACTION_getCompatibleMagnificationSpecForWindow, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = android.view.MagnificationSpec.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
/**
     ...
     */
@Override public void setTouchExplorationEnabled(boolean enabled) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(((enabled)?(1):(0)));
mRemote.transact(Stub.TRANSACTION_setTouchExplorationEnabled, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_pauseKeyDispatching = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_resumeKeyDispatching = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_setEventDispatching = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_addWindowToken = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_removeWindowToken = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_addAppToken = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_setAppGroupId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_setAppOrientation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_getAppOrientation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_setFocusedApp = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_prepareAppTransition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_getPendingAppTransition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_overridePendingAppTransition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_overridePendingAppTransitionScaleUp = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_overridePendingAppTransitionThumb = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_executeAppTransition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_setAppStartingWindow = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_setAppWillBeHidden = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_setAppVisibility = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_startAppFreezingScreen = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_stopAppFreezingScreen = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_removeAppToken = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_updateOrientationFromAppTokens = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_setNewConfiguration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_startFreezingScreen = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_stopFreezingScreen = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
...
static final int TRANSACTION_setInTouchMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
static final int TRANSACTION_showStrictModeViolation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
static final int TRANSACTION_setStrictModeVisualIndicatorPreference = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
static final int TRANSACTION_updateRotation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 55);
static final int TRANSACTION_getRotation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 56);
...
static final int TRANSACTION_screenshotApplications = (android.os.IBinder.FIRST_CALL_TRANSACTION + 63);
static final int TRANSACTION_statusBarVisibilityChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 64);
static final int TRANSACTION_waitForWindowDrawn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 65);
static final int TRANSACTION_hasNavigationBar = (android.os.IBinder.FIRST_CALL_TRANSACTION + 66);
static final int TRANSACTION_lockNow = (android.os.IBinder.FIRST_CALL_TRANSACTION + 67);
static final int TRANSACTION_getFocusedWindowToken = (android.os.IBinder.FIRST_CALL_TRANSACTION + 68);
static final int TRANSACTION_setInputFilter = (android.os.IBinder.FIRST_CALL_TRANSACTION + 69);
static final int TRANSACTION_getWindowFrame = (android.os.IBinder.FIRST_CALL_TRANSACTION + 70);
static final int TRANSACTION_isSafeModeEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 71);
static final int TRANSACTION_setMagnificationCallbacks = (android.os.IBinder.FIRST_CALL_TRANSACTION + 72);
static final int TRANSACTION_setMagnificationSpec = (android.os.IBinder.FIRST_CALL_TRANSACTION + 73);
static final int TRANSACTION_getCompatibleMagnificationSpecForWindow = (android.os.IBinder.FIRST_CALL_TRANSACTION + 74);
static final int TRANSACTION_setTouchExplorationEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 75);
}
/**
     * ===== NOTICE =====
     * The first three methods must remain the first three methods. Scripts
...
public void addAppToken(int addPos, android.view.IApplicationToken token, int groupId, int stackId, int requestedOrientation, boolean fullscreen, boolean showWhenLocked, int userId, int configChanges) throws android.os.RemoteException;
...
/**
     ...
     * Returns true if really waiting, false if the window does not exist.
     */
public boolean waitForWindowDrawn(android.os.IBinder token, android.os.IRemoteCallback callback) throws android.os.RemoteException;
/**
     * Device has a software navigation bar (separate from the status bar).
     */
...
/**
     * Sets an input filter for manipulating the input event stream.
     */
public void setInputFilter(android.view.IInputFilter filter) throws android.os.RemoteException;
/**
     * Gets the frame of a window given its token.
     */
public void getWindowFrame(android.os.IBinder token, android.graphics.Rect outFrame) throws android.os.RemoteException;
/**
     * Device is in safe mode.
     */
...
/**
     ...
     * @param callbacks The magnification callbacks.
     */
public void setMagnificationCallbacks(android.view.IMagnificationCallbacks callbacks) throws android.os.RemoteException;
/**
     * Sets the magnification spec to be applied to all windows that can be
     * magnified.
     *
     * @param spec The current magnification spec.
     */
public void setMagnificationSpec(android.view.MagnificationSpec spec) throws android.os.RemoteException;
/**
     * Gets the magnification spec for a window given its token. If the
     * window has a compatibility scale it is also folded in the returned
     * magnification spec.
     ...
     * @return The magnification spec if such or null.
     */
public android.view.MagnificationSpec getCompatibleMagnificationSpecForWindow(android.os.IBinder windowToken) throws android.os.RemoteException;
/**
     * Sets the current touch exploration state.
     *
     * @param enabled Whether touch exploration is enabled.
     */
public void setTouchExplorationEnabled(boolean enabled) throws android.os.RemoteException;
}
